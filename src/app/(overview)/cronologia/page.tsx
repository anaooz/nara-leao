    ...
    return(
        <>
            ...
            <article className="flex flex-col conteudo-pagina [&>p]:pb-4">
                ...
                <h2 className="anos">1954</h2>
                <p className="acontecimentos">Nara ganha do pai o seu primeiro violão e passa a fazer aulas com o músico Patrício Teixeira. Nessa época, ela estudava no mesmo colégio de Roberto Menescal e, já com doze anos, o apresentava em discos as novidades do jazz norte-americano.</p>
            
                <h2 className="anos">1956</h2>
                <p className="acontecimentos">Nara se matricula na Academia de Violão de Menescal e Carlos Lyra, na Rua Sá Ferreira.</p>

                <div className="right-[4%] top-[35%] fotos-cronologia">
                    <Link href="/galeria">                    
                        <Image
                ...
                <h2 className="anos">1957</h2>
                <p className="acontecimentos">Durante esse ano ocorrem no apartamento de Nara as primeiras das famosas reuniões do grupo de jovens músicos que participariam da Bossa Nova. O apartamento era localizado no edifício Champ-Elysées, em frente ao posto 4 da Avenida Atlântica, Copacabana.</p>

                <h2 className="anos">1958</h2>
                <p>Após contrair uma hepatite, Nara se ausenta do colégio por dois meses. Logo depois desse evento, larga em definitivo os estudos, no segundo científico.</p>
                <p className="acontecimentos">Durante breve período, trabalha como secretária de redação e repórter do “Tablóide UH”, caderno de utilidades comandado por Alberto Dines no jornal Última Hora, de Samuel Wainer.</p>

                <h2 className="anos">1959</h2>
                <p>No dia 22 de setembro, Nara participa apenas como platéia no I Festival de Samba Session realizado na PUC-RJ. Esse seria um dos primeiros shows com o grupo de músicos envolvidos com a nascente Bossa Nova.</p>
                ...
                <p className="acontecimentos">Inicia seu namoro com Ronaldo Bôscoli.</p>
            
                <h2 className="anos">1960</h2>
                <p>Nara passa a frequentar o consultório do psicanalista Ivan Ribeiro, um dos membros fundadores da primeira turma do Instituto de Medicina Psicológica ao lado de Hélio Pellegrino.</p>
                ...
                <p className="acontecimentos">Em junho a revista Singra, encarte do jornal Correio da Manhã, publica uma reportagem feita durante uma reunião de músicos na casa de Nara Leão.</p>
                
                <div className="left-[0.8%] top-[150%] fotos-cronologia">
                    <Link href="/galeria">                    
                        <Image
                ...
                <h2 className="anos">1961</h2>
                <p>Paralelamente a iniciante carreira de cantora, Nara se dedica às artes plásticas, mais especificamente à xilogravura. Com 500 candidatos concorrendo para o X Salão Nacional de Arte Moderna, Nara e suas obras foram classificadas dentre 138 trabalhos.</p>
                <p className="acontecimentos">Termina seu relacionamento com Ronaldo Bôscoli.</p>
            
                <h2 className="anos">1962</h2>
                <p>Nara continua participando esparsamente de shows ao redor do país, cantando basicamente um repertório ligado a Bossa Nova, sempre acompanhada dos músicos do movimento.</p>
                <p className="acontecimentos">Inicia seu namoro com o cineasta e compositor moçambicano Ruy Guerra.</p>

                <h2 className="anos">1963</h2>
                <p>Em março, na boate Au bom gourmet em Copacabana, Nara se apresenta pela primeira vez como cantora profissional, dividindo o palco com Carlos Lyra e Vinícius de Moraes no espetáculo Pobre Menina Rica, escrito pelos dois.</p>
                <p>Primeiras apresentações em programas de TV de diferentes estados.</p>    
                <p className="acontecimentos">Em agosto, no estúdio Rio-Som da Rua do Senado, Rio de Janeiro, inicia a gravação do seu primeiro disco de carreira. A gravadora era a recém-fundada Elenco, de Aloysio de Oliveira.</p>

                <h2 className="anos">1964</h2>
                <p>Ano de ascensão pública de Nara como uma das maiores cantoras do país. Suas opiniões políticas e declarações a favor dos movimentos de esquerda geravam polêmicas nos jornais.</p>
                ...
                <p className="acontecimentos">Em Novembro é lançado Opinião de Nara, segundo disco da cantora, pela Philips. O disco, com repertório na mesma linha do primeiro, torna-se a inspiração para o espetáculo musical Opinião, escrito por Oduvaldo Vianna Filho, Paulo Pontes e Armanda Costa, dirigido por Augusto Boal e encenado pela própria Nara, por Zé Ketti e João do Vale.</p>

                <h2 className="anos">1965</h2>
                <p>Nara inicia o ano como uma das principais personalidades do país devido ao sucesso de seus discos e do espetáculo Opinião. A crítica musical debate não só suas canções como suas declarações públicas em entrevistas.</p>
                ...
                <p className="acontecimentos">A Philips lança o LP 5 na bossa – Nara, Edu Lobo, Tamba Trio, resultado de um show realizado no Teatro Paramount durante esse ano.</p>

                <h2 className="anos">1966</h2>
                <p>Em janeiro Nara sai em viagem de férias para Nova York e para a Europa.</p>
                ...
                <p className="acontecimentos">Ano em que inicia o namoro com o cineasta Cacá Diegues.</p>

                <div className="right-[0.8%] top-[330%] fotos-cronologia">
                    <Link href="/galeria">                    
                        <Image
                ...
                <h2 className="anos">1967</h2>
                <p>Em maio Nara e Chico Buarque apresentam o último programa Pra ver a banda passar na Rede Record.</p>
                ...
                <p className="acontecimentos">Participa do filme Garota de Ipanema de Leon Hirszman e Vinícius de Moraes.</p>

                <div className="left-[2%] top-[400%] fotos-cronologia">
                    <Link href="/galeria">                    
                        <Image
                ...
                <p className="acontecimentos">Participa do disco coletivo Tropicalia ou Panis et circenses com a gravação de “Lindonéia”, composição de Caetano Veloso feita a pedido da cantora e inspirada em uma obra do pintor Rubens Gerchman.</p>

                <h2 className="anos">1969</h2>
                <p>Ano em que o regime militar fecha o cerco sobre a sociedade. Nesse período, Nara diminui bastante suas atividades musicais no Brasil.</p>
                <p>Em abril ela participa de uma temporada de shows em Portugal ao lado de Chico Buarque e Vinícius de Moraes, ambos moradoresda Europa durante esse período.</p>
                ...
                <p className="acontecimentos">No fim do ano, Nara deixa o país com Cacá Diegues para viverem um período de exílio na Europa. Moram em Paris, onde Nara passa a ter uma vida cotidiana longe da fama que a acompanhava – e a incomodava – no Brasil.</p>

                <div className="right-[2%] top-[505%] fotos-cronologia">
                    <Link href="/galeria">                    
                        <Image
                ...
                <h2 className="anos">1970</h2>
                <p>Período em que Nara vive em Paris ao lado de Cacá Diegues.</p>
                ...
                <p className="acontecimentos">Ainda em Paris resolve gravar para Philips um álbum duplo com vinte e quatro canções do período da Bossa Nova. O disco traz composições de Tom Jobim com seus parceiros Newton Mendonça, Vinícius de Moraes e Chico Buarque, além de canções de Carlos Lyra, Johnny Alf e Baden Powell. Gravado apenas com violão e piano e com a participação da cantora e violonista Tuca, o disco ganhou arranjos de cordas de Luis Eça e Rogério Duprat e foi lançado com o título Dez anos depois.</p>

                <h2 className="anos">1971</h2>
                <p>Nara Leão e Cacá Diegues voltam a morar no Brasil.</p>
                ...
                <p className="acontecimentos">É lançado pela Philips o álbum duplo Dez anos depois.</p>

                <h2 className="anos">1972</h2>
                <p>Em 17 de janeiro nasce o segundo filho de Nara Leão e Cacá Diegues, Francisco. Nara participa como atriz ao lado de Maria Bethânia e Chico Buarque do filme Quando o carnaval chegar dirigido pelo marido Cacá Diegues.</p>
                ...
                <p className="acontecimentos">Em agosto, faz uma série de apresentações na boate Flag, no Rio de Janeiro. O registro dessa apresentação seria lançado em 1976 em um mini-LP com o título Palco, corpo e alma.</p>

                <div className="left-[2%] top-[607.5%] fotos-cronologia">
                    <Link href="/galeria">                    
                        <Image
                ...
                <h2 className="anos">1973</h2>
                <p>Nara inicia o ano apoiando a carreira de um jovem cantor cearense que logo faria sucesso, chamado Fagner. Ela participa de seu primeiro disco e divide com ele o palco nos shows de lançamento do disco, em fevereiro.</p>
                ...
                <p className="acontecimentos">Inicia sua volta aos bancos escolares, terminando o segundo grau, abandonado em prol da carreira da cantora ainda em 1958. No ano seguinte, Nara faz o vestibular para cursar psicologia na Pontífice Universidade Católica do Rio de Janeiro – PUC.</p>

                <h2 className="anos">1974</h2>
                <p>Ano em que Nara volta a gravar um LP pela Philips. Produzido por seu amigo de juventude Roberto Menescal, Meu primeiro amor é um disco pessoal, em que a cantora grava as canções que tocava ao violão para seus filhos pequenos.</p>
                ...
                <p className="acontecimentos">Nara é aprovada no vestibular de Psicologia na PUC-RJ.</p>

                <h2 className="anos">1975</h2>
                <p className="acontecimentos">A gravadora Philips lança o disco Meu primeiro amor. Por ser um disco sem apelo comercial, a cantora não faz shows de divulgação. Mesmo assim, ganha o prêmio de Melhor Cantora do Ano da Associação dos Críticos de Arte de São Paulo.</p>
            
                <h2 className="anos">1977</h2>
                <p>Após um período dedicado aos seus estudos de psicologia e aos filhos, Nara retorna ao universo da música popular, gravando o disco Meus amigos são um barato. Um disco com parcerias com alguns de seus amigos da Bossa Nova, como Tom, João Donato, Menescal e Boscôli, amigos compositores, como Gilberto Gil, Chico Buarque, Caetano Veloso e Edu Lobo e com novos amigos como, Dominguinhos e Sivuca.</p>
                ...
                <p className="acontecimentos">Nara e Cacá Diegues se separam.</p>

                <h2 className="anos">1978</h2>
                <p>Nara sai em bem sucedida turnê nacional com um show que reunia Dominguinhos e os grupos Ritmos Nordestinos e Os Carioquinhas. Esse grupo de choro do Rio de Janeiro trazia entre seus componentes os muito jovens violonistas Raphael Rabelo e Maurício Carrilho e a cavaquinista Luciana Rabelo.</p>
                <p className="acontecimentos">Gravação e lançamento do surpreendente disco E que tudo mais vá para o inferno, dedicado inteiramente à obra de Roberto e Erasmo Carlos.</p>

                <h2 className="anos">1979</h2>
                <p>Ano em que Nara descobre problemas de saúde. Nara grava e lança em abril o disco Com açúcar e com afeto, que assim como o disco anterior, era todo dedicado ao repertório de um compositor. Dessa vez, ela dedica o disco às canções de seu amigo Chico Buarque.</p>
                <p className="acontecimentos">Durante o ano, faz uma série de viagens para divulgação do disco, dando entrevistas para rádios e televisão. Algumas vezes, sente-se mal durante as entrevistas.</p>

                <h2 className="anos">1981</h2>
                <p>Apresentação no Festival de Guarujá.</p>
                ...
                <p className="acontecimentos">Em agosto Nara estréia em São Paulo, no teatro Tuca, o show Romance Popular, com direção de Flávio Rangel.</p>

                <h2 className="anos">1982</h2>
                <p>Estréia em janeiro o show Romance Popular no Rio de Janeiro, no hotel Rio Palace.</p>
                ...
                <p className="acontecimentos">Em dezembro estréia o show Nasci para bailar no Teatro da Lagoa, Rio de Janeiro. Durante três semanas de casa cheia, Nara reedita sua parceria com os músicos dos Carioquinhas, agora reagrupados na Camerata Carioca e incorpora ritmistas do Bloco Cacique de Ramos. O show ainda viajaria por diversas cidades do país.</p>

                <h2 className="anos">1983</h2>
                <p>No início do ano Nara participa ao lado de Chico Buarque e Fagner de um grande show de desagravo para o cantor português Sérgio Godinho, detido pela Polícia Federal brasileira há mais de dois meses.</p>
                ...
                <p className="acontecimentos">Participa do Projeto Pixinguinha ao lado da Camerata Carioca, cumprindo um roteiro de shows por várias cidades brasileiras. Nas apresentações, o repertório do disco Meu samba encabulado.</p>

                <div className="right-[2%] top-[890%] fotos-cronologia">
                    <Link href="/galeria">                    
                        <Image
                ...
                <h2 className="anos">1984</h2>
                <p>Nara se apresenta pela primeira vez apenas acompanhada de seu violão no show Com açúcar e com afeto, no antigo teatro BNH, atual Teatro Nelson Rodrigues.</p>
                ...
                <p className="acontecimentos">Em julho participa em São Paulo da comemoração pelos dez anos da Fundação Vianinha, em homenagem ao seu amigo e um dos escritores do espetáculo Opinião, Oduvaldo Vianna Filho.</p>

                <h2 className="anos">1985</h2>
                <p>Nara inicia o ano com uma bem sucedida mini-temporada de voz e violão na boate People, no Rio de Janeiro.</p>
                ...
                <p className="acontecimentos">A viagem ao Japão ainda rende a produção do primeiro Compact Disc de um artista brasileiro. Gravado durante o mês de junho na Polygram do Japão e com o repertório todo dedicado à Bossa Nova, o título escolhido foi Garota de Ipanema.</p>

                <h2 className="anos">1986</h2>
                <p>Período em que se agravam os problemas de saúde de Nara. Grande parte do seu tempo é dividido entre sua recuperação em tratamentos e sua ainda ativa carreira musical.</p>
                <p className="acontecimentos">É lançado no Brasil o disco Garota de Ipanema, gravado no Japão durante o ano anterior.</p>

                <h2 className="anos">1987</h2>
                <p>Com um quadro de melhora, volta a dar shows com freqüência, quase sempre ao lado de Roberto Menescal.</p>
                ...
                <p className="acontecimentos">Em agosto é lançado o disco Meus sonhos dourados, com clássicos da música popular norte-americana em versões brasileiras feitas por ela e outros como Ronaldo Bôscoli e Fátima Guedes.</p>

                <h2 className="anos">1988</h2>
                <p>Mais uma temporada de shows com grande sucesso – cinco semanas – de Nara e Menescal na boate People, no Rio de Janeiro. Os dois viajam por várias cidades com seu show.</p>
                ...
                <p className="acontecimentos">Durante o ano, Nara elabora e divide com Nelson Motta uma nova série de versões de músicas norte-americanas para gravar em seu último disco de carreira, encomendado pela Polygram do Japão e intitulado My foolish heart.</p>

                <h2 className="anos">1989</h2>
                <p>A cantora realiza seu último show em uma mini-turnê por cidades do Norte do Brasil, apresentando-se em março no Iate Clube de Belém do Pará.</p>
                <p className="acontecimentos">Nara Leão falece na Casa de Saúde São José, Rio de Janeiro, no dia 7 de junho.</p>

                <h2 className="anos">2022</h2>
                <p>Em homenagem aos 80 anos da cantora, a série documental O Canto Livre de Nara Leão é lançado pela Globoplay.</p>
                <div className="left-[3.5%] top-[1050%] fotos-cronologia">
                    ...
                    <p className="border-0 pb-0 mb-0 text-right font-bold">Pôster de O Canto Livre de Nara Leão</p>
                </div>
            </article>
        </>
    )
